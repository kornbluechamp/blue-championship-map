...
function emptyDataset(){return{version:5,event:'The Blue Championship',course:'TPC Colorado',createdAt:new Date().toISOString(),updatedAt:new Date().toISOString(),points:[],routes:[],activeRoute:null}}
...
function pointIcon(type,label='',iconType=''){
  ...
  const chars={restroom:'R',accessible_restroom:'R',firstaid:'+',concession:'C',water:'W',gate:'G',volunteer:'V',junction:'J',crossing:'X',restriction:'!',hole:'H',expo:'E',viewing:'P',hospitality:'H',proshop:'P',clubhouse:'CL',other:'•'};
  const classes={restroom:'marker-restroom',accessible_restroom:'marker-restroom',firstaid:'marker-firstaid',concession:'marker-concession',water:'marker-concession',hole:'marker-hole',junction:'marker-junction',crossing:'marker-junction',restriction:'marker-restriction',proshop:'marker-place',clubhouse:'marker-place',hospitality:'marker-place',gate:'marker-place',volunteer:'marker-volunteer'};
...
function markerPopup(p){
  const typeLabel=p.type==='accessible_restroom'?'Accessible restroom':String(p.type||'location').replaceAll('_',' ');
